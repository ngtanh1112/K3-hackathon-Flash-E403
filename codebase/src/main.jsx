...
//     >
//       {/* ── Header ── */}
//       <div className="flex items-center justify-between border-b border-vlearn-line px-5 py-3.5 shrink-0">
//         <div className="flex items-center gap-2.5">
//           <div className="grid h-9 w-9 place-items-center rounded-xl bg-vlearn-teal-light text-vlearn-teal shrink-0">
//             <BrainCircuit size={18} />
//           </div>
//           <div className="min-w-0">
//             <h2 className="text-sm font-black leading-tight">AI Quiz</h2>
//             <p className="text-[10px] font-medium text-vlearn-muted truncate">{lesson?.title}</p>
//           </div>
//         </div>
//         <button onClick={onClose}
//           className="grid h-8 w-8 place-items-center rounded-full border border-vlearn-line text-vlearn-muted hover:bg-slate-50 transition-colors">
//           <X size={15} />
//         </button>
//       </div>
...
//             {/* Input */}
//             <div className="border-t border-vlearn-line px-4 py-3 shrink-0 bg-white">
//               <div className="rounded-xl border border-vlearn-line bg-slate-50 flex items-end gap-2 px-3 py-2.5 focus-within:border-vlearn-teal/50 focus-within:bg-white transition-colors">
//                 <textarea
//                   ref={inputRef}
//                   value={inputText}
//                   onChange={(e) => setInputText(e.target.value)}
//                   onKeyDown={handleKeyDown}
//                   placeholder='Hỏi về bài học... hoặc "tạo quiz 20"'
//                   rows={1}
//                   disabled={isSending}
//                   className="flex-1 resize-none bg-transparent text-xs font-medium text-slate-800 placeholder:text-slate-400 outline-none leading-5 max-h-[100px]"
//                   style={{ height: "auto" }}
//                   onInput={(e) => {
...
//                 AI chỉ trả lời trong phạm vi bài học · Enter để gửi
//               </p>
//             </div>
//           </motion.div>
//         ) : (
...
//                     className="h-9 rounded-xl border border-vlearn-line text-xs font-bold text-slate-500 hover:bg-slate-50 transition-colors"
//                   >
//                     💬 Chat
//                   </button>
//                   <button
...
//     >
//       {!isUser && (
//         <div className="h-7 w-7 shrink-0 rounded-full bg-vlearn-teal-light grid place-items-center text-vlearn-teal mt-0.5">
//           <Bot size={14} />
//         </div>
//       )}
//       <div className={`max-w-[80%] rounded-2xl px-3.5 py-2.5 text-xs leading-5 ${
//         isUser
...
//       <div className="h-7 w-7 shrink-0 rounded-full bg-vlearn-teal-light grid place-items-center text-vlearn-teal">
//         <Bot size={14} />
//       </div>
...
//           AI sẽ sinh {questionCount} câu dựa trên nội dung bài giảng thật
//         </p>
//       </div>
...
//       {/* Quick AI Chat */}
//       <div className="rounded-2xl border border-vlearn-line bg-white p-3">
//         <p className="text-[10px] font-bold text-slate-500 mb-2 flex items-center gap-1">
//           <MessageSquare size={10} />
//           Hỏi AI về bài học hoặc ra lệnh tạo quiz
//         </p>
...
//             placeholder='Ví dụ: "tạo 20 quiz" hoặc hỏi bất kỳ...'
//             className="flex-1 text-[11px] rounded-lg border border-vlearn-line bg-slate-50 px-3 py-2 outline-none focus:border-vlearn-teal/50 focus:bg-white placeholder:text-slate-400 transition-colors"
//           />
//           <button
...
//           {answered > 0 && <span className="text-emerald-600">{correct} đúng</span>}
...
//           {question.topic && (
//             <span className="text-[10px] font-bold text-slate-500 bg-slate-100 rounded-full px-2 py-0.5">{question.topic}</span>
//           )}
//           {question.difficulty && (
...
//           {[["Điểm", `${score}/${total}`, "text-vlearn-teal"], ["Accuracy", `${accuracy}%`, "text-vlearn-teal"], ["Sai", total - score, "text-red-500"]].map(([label, val, color]) => (
//             <div key={label} className="rounded-xl border border-vlearn-line bg-slate-50 p-3">
...
//           <p className="text-xs font-black text-amber-800 mb-2">📌 Chủ đề cần ôn lại ({wrongQuestions.length} câu)</p>
//           <ul className="space-y-1">
//             {[...new Set(wrongQuestions.map((q) => q.topic))].map((t) => (
//               <li key={t} className="text-xs text-amber-700 flex items-center gap-1">
//                 <span className="w-1.5 h-1.5 rounded-full bg-amber-500 shrink-0" />{t}
//               </li>
//             ))}
//           </ul>
//         </div>
...
//                         <p className="text-[10px] font-black text-red-600 mb-1">Câu {origIdx + 1} · {q.topic}</p>
...
//       <div className="grid grid-cols-3 gap-2">
//         <button onClick={onBackToChat}
//           className="h-10 rounded-xl border border-vlearn-line font-bold text-slate-500 text-xs hover:bg-slate-50 transition-colors">
//           💬 Chat
//         </button>
//         <button onClick={onRetry}
//           className="h-10 rounded-xl border border-vlearn-line font-bold text-slate-600 text-xs hover:bg-slate-50 transition-colors">
//           Làm lại
//         </button>
